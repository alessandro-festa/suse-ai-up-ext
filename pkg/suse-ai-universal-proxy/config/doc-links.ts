...
export const DOC_BASE_URLS = {
  ...
  GITHUB: 'https://github.com/suse/suse-ai-universal-proxy'
} as const;
...
export const DOCUMENTATION_LINKS: Record<string, DocLink> = {
  ...
  overview: {
    ...
    url: `${DOC_BASE_URLS.SUSE}/suse-ai-universal-proxy/overview`,
  ...
  installation: {
    ...
    url: `${DOC_BASE_URLS.SUSE}/suse-ai-universal-proxy/installation`,
    category: DOC_CATEGORIES.GETTING_STARTED,
  ...
  quickStart: {
    ...
    url: `${DOC_BASE_URLS.SUSE}/suse-ai-universal-proxy/quick-start`,
    category: DOC_CATEGORIES.GETTING_STARTED,
  ...
  managingApps: {
    ...
    url: `${DOC_BASE_URLS.SUSE}/suse-ai-universal-proxy/user-guide/managing-apps`,
  ...
  repositories: {
    ...
    url: `${DOC_BASE_URLS.SUSE}/suse-ai-universal-proxy/user-guide/repositories`,
    category: DOC_CATEGORIES.USER_GUIDE,
  ...
  multiCluster: {
    ...
    url: `${DOC_BASE_URLS.SUSE}/suse-ai-universal-proxy/user-guide/multi-cluster`,
    category: DOC_CATEGORIES.USER_GUIDE,
  ...
  bulkOperations: {
    ...
    url: `${DOC_BASE_URLS.SUSE}/suse-ai-universal-proxy/user-guide/bulk-operations`,
    category: DOC_CATEGORIES.USER_GUIDE,
  ...
  configuration: {
    ...
    url: `${DOC_BASE_URLS.SUSE}/suse-ai-universal-proxy/admin-guide/configuration`,
  ...
  security: {
    ...
    url: `${DOC_BASE_URLS.SUSE}/suse-ai-universal-proxy/admin-guide/security`,
    category: DOC_CATEGORIES.ADMIN_GUIDE,
  ...
  monitoring: {
    ...
    url: `${DOC_BASE_URLS.SUSE}/suse-ai-universal-proxy/admin-guide/monitoring`,
    category: DOC_CATEGORIES.ADMIN_GUIDE,
  ...
  commonIssues: {
    ...
    url: `${DOC_BASE_URLS.SUSE}/suse-ai-universal-proxy/troubleshooting/common-issues`,
  ...
  diagnostics: {
    ...
    url: `${DOC_BASE_URLS.SUSE}/suse-ai-universal-proxy/troubleshooting/diagnostics`,
    category: DOC_CATEGORIES.TROUBLESHOOTING,
